...
class Spider(object):
    ...
    def encryption(msg):
        ...
        """
        modulus = "009585A4773ABEECB949701D49762F2DFAB9599BA19DFE1E1A2FA200E32E0444F426DA528" \
    ...
    def login(self, login_info):
        ...
        self.req_session.post("http://www.ximalaya.com/passport/security/popupLogin", data=login_info,
                              headers=my_header)
    ...
    def upload_file(self, album_id, file_full_name):
        ...
        self.req_session.get("http://www.ximalaya.com/passport/check_me", params=check_me_info,
                             headers=my_header)
        # 上传音频
        upload_info = {
        ...
        file1 = {'file': (basename(file_full_name), open(file_full_name, 'rb'), common.get_mime_type(file_full_name),
                          {'Expires': '0'})}
        resp = self.req_session.post("http://upload.ximalaya.com/dtres/audio/upload", params=upload_info,
                                     files=file1, headers=my_header)
        ...
        if json_upload_result["status"]:
            ...
            self.req_session.get(jindu_url, headers=my_header)
            self.req_session.get("http://www.ximalaya.com/dtres/transcode/url",
                                 params={"uploadTrackId": fileid}, headers=my_header)
            # 发布
            ...
            resp = self.req_session.post("http://www.ximalaya.com/upload2/create", data=create_data,
                                         headers=my_header)
            return resp.text
